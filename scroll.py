...
def get_image(start, urls):
	import random, time

	random_page = random.randint(0, len(urls)-1)
	soup = BeautifulSoup(urllib2.urlopen(urls[random_page]))
...
def place():
	...
	place_urls = ['http://www.uesp.net/w/index.php?title=Category:Morrowind-Place_Images',
		'http://www.uesp.net/w/index.php?title=Category:Morrowind-Place_Images&filefrom=Holamayan%0AMW-place-Holamayan+2.jpg#mw-category-media',
		'http://www.uesp.net/w/index.php?title=Category:Morrowind-Place_Images&filefrom=MW-place-St.+Olms+Storage.jpg#mw-category-media',
		'http://www.uesp.net/w/index.php?title=Category:Morrowind-Place_Images&filefrom=Ularradallaku%0AMW-place-Ularradallaku.jpg#mw-category-media']

	image = get_image(start, place_urls)
